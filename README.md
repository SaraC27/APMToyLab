...
Al desarrollar este proyecto, me he dado cuenta de lo valioso que es integrar múltiples áreas de la ingeniería en un solo trabajo. En la universidad, muchas veces aprendemos los conceptos de manera aislada, como si cada rama de la ingeniería fuera independiente de las demás. Sin embargo, cuando nos enfrentamos a un proyecto real, todo cambia. Es necesario combinar conocimientos de mecánica, electrónica, automatización y hasta informática para encontrar soluciones eficientes. Esto me ha hecho ver la importancia de tener una visión global, de no limitarme a una sola área, sino de entender cómo se conectan entre sí para poder resolver problemas complejos de manera integral.

Además, algo que me ha parecido fundamental en este proceso es el enfoque económico y financiero que se le da al proyecto. Muchas veces, cuando uno está inmerso en el desarrollo técnico, puede olvidar que cualquier idea, por innovadora que sea, necesita ser viable económicamente para que realmente funcione en el mundo real. Este aspecto me ha permitido ver más allá de lo puramente ingenieril y comprender el papel clave que juegan la administración y la gestión de recursos en la toma de decisiones. Me ha dado una nueva perspectiva sobre la ingeniería, no solo como un campo de soluciones técnicas, sino también como un área que debe considerar costos, beneficios y sostenibilidad.

Otro aspecto que considero muy enriquecedor es el trabajo en equipo. Antes de este proyecto, tenía claro que la colaboración era importante, pero vivirlo en la práctica es otra historia. Coordinar esfuerzos, comunicarse efectivamente y tomar decisiones en conjunto son retos que requieren paciencia y compromiso. He aprendido que la parte técnica puede ser complicada, pero lo realmente desafiante es lograr que un grupo de personas con diferentes formas de pensar y de trabajar puedan alinearse hacia un mismo objetivo. Esto ha sido una gran lección, porque me ha permitido desarrollar habilidades blandas que, sin duda, serán esenciales en mi futuro profesional.

Finalmente, una de las cosas que más valoro de esta experiencia es que nos acerca, aunque sea de manera parcial, a lo que será el mundo laboral. En la universidad, solemos trabajar en proyectos teóricos, con condiciones controladas, pero este proyecto nos ha permitido enfrentarnos a situaciones más reales: plazos ajustados, limitaciones de recursos, toma de decisiones bajo presión. Ha sido un pequeño vistazo a lo que nos espera fuera de la academia, y me ha hecho reflexionar sobre la importancia de estar preparado no solo con conocimientos técnicos, sino también con una mentalidad flexible y resolutiva.
